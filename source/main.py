...
def elaboraFrase():
   ...
   for i in range(len(frase)):
       ...
       button.append(tk.Button(lower_frame, text='\U0001F603', font= fontStyle, command= lambda parola=parola: usaEmoji(frase,parola)))
...
def usaEmoji(frase,parola):
    emoji = '\U0001F603'
    frase[frase.index(parola)] = emoji
    frase_nuova = ' '.join(frase)
